    ...
    <div className="flex h-screen">
      <div className="h-screen ">
        ...
        >
          <FontAwesomeIcon
            icon={faAngleLeft}
            className={` absolute cursor-pointer -right-3 top-9 w-6 rounded-full bg-borderCol h-6  text-white`}
            onClick={() => setOpen(!open)}
          />
          <div className={`h-full px-3 py-4 bg-gray-50 `}>
            <div className="flex items-center px-4 py-10 space-x-3">
            ...
            <ul className="px-2 space-y-6 font-medium">
              <li>
                <a
                  href="#"
              ...
              <li>
                <a
                  href="#"
                  className="flex items-center p-2 text-white rounded-lg bg-borderCol dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                >
              ...
              <li>
                <a
                  href="#"
                  className="flex items-center p-2 rounded-lg text-dabTextCol dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                >
            ...
            >
              <div className="">
                ...
                <button className="block px-10 py-3 m-auto mt-6 font-bold bg-white rounded-full text-btnTextCol">
                  Get Pro Now!
                </button>
              </div>
              <div className="flex justify-between py-20 pl-4 m-auto w-60">
